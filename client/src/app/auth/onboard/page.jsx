...
export default function MentalHealthForm() {
	...
	const validateStep2 = () => {
		...
		if (!formData.sleepHabits)
			newErrors.sleepHabits = "Sleep habits are required";
		if (!formData.physicalActivities)
			newErrors.physicalActivities = "Physical activities info is required";
		return newErrors;
	};
	...
	if (step === 4) {
		return (
			<div className='min-h-screen bg-gray-50 flex items-center justify-center p-4'>
				<div className='bg-white rounded-2xl shadow-professional-lg border border-gray-200 p-8 max-w-md w-full text-center'>
					...
					<p className='text-gray-600 mb-8'>
						...
						tracking your wellness journey with NeuroWell.
					</p>
					<div className='space-y-3'>
						<button
							...
							className='w-full bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-all duration-200 font-semibold shadow-professional'>
	...
	return (
		<div className='min-h-screen bg-gray-50 flex items-center justify-center p-4'>
			<div className='bg-white rounded-2xl shadow-professional-lg border border-gray-200 p-8 max-w-2xl w-full'>
				<div className='mb-8'>
						...
						<div className='space-y-6'>
							...
							<div>
								...
								<input
									...
									} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition text-gray-900 placeholder-gray-400`}
						...
						<div className='space-y-6'>
							...
							<div>
								...
								<select
									...
									onChange={handleChange}
									className={`w-full px-4 py-3 border ${
										errors.workspace ? "border-red-500" : "border-gray-300"
									} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition text-gray-900`}>
							...
							<div>
								...
								<select
									...
									onChange={handleChange}
									className={`w-full px-4 py-3 border ${
										errors.sleepHabits ? "border-red-500" : "border-gray-300"
									} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition text-gray-900`}>
						...
						<div className='space-y-6'>
							...
							<div className='bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6'>
								<p className='text-sm text-blue-800'>
									This information is optional and will be kept strictly
									confidential. It helps us provide better support and
									resources.
								</p>
							</div>
					...
					<div className='flex justify-between mt-8 pt-6 border-t border-gray-200'>
						{step > 1 && (
							<button
								type='button'
								onClick={handleBack}
								className='flex items-center gap-2 px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 font-semibold shadow-sm'>
						...
						<button
							...
							className='flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 hover:shadow-professional transition-all duration-200 font-semibold ml-auto'>
